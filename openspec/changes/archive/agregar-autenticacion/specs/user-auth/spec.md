...
Esta spec describe el contrato observable (qué debe ser cierto) tras aplicar el
cambio `agregar-autenticacion`. No describe implementación interna; eso pertenece
al artefacto de diseño.

Todos los endpoints viven bajo el prefijo `/api`. Las contraseñas nunca viajan
hacia afuera del sistema ni se almacenan en claro.
